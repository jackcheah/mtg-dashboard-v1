            ...
            document.addEventListener('DOMContentLoaded', () => {
                ...
                if (timerSection) timerSection.classList.add('sticky');
            ...
            async function startTimer() {
                try {
                    ...
                    showToast('Timer Started', 'Round timer is now running', 'success');
                } catch (e) {
                    showToast('Error', 'Failed to start timer - server unreachable', 'error');
                }
            }
            ...
            async function stopTimer() {
                try {
                    ...
                    updateTimerDisplay();
                    showToast('Timer Stopped', 'Round timer has been paused', 'warning');
                } catch (e) {
                    showToast('Error', 'Failed to stop timer - server unreachable', 'error');
                }
            }
            ...
            async function resetTimer() {
                try {
                    ...
                    showToast('Error', 'Failed to reset timer - server unreachable', 'error');
                }
            }

            // Sync from server once on load (and on restore)
